...
export class ProfileComponent implements OnInit {
  ...
  getProfileDetails() {
    ...
    this.employerService.profileDetails(payload)
      .subscribe(
        (response) => {
          this.spinner.hide();
          ...
          if (response.statusCode == 200) {
            ...
            this.accountForm.patchValue({
              ...
              company_name: this.userData.company_name == null ? '' : this.userData.company_name,
              user_phone_number: this.userData.user_phone_number == null ? '' : this.userData.user_phone_number,
              user_company_type: this.userData.user_company_type == null ? '' : this.userData.user_company_type,
  ...
  updateAccountInfo() {
    ...
    this.employerService.updateProfile(payload)
      .subscribe(
        (response) => {
          this.spinner.hide();
          if (response.statusCode == 200) {
